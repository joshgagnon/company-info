...
describe('DB Functions', () => {
    ...
    it('company_from_nzbn_at_date should find the previous names of "CONSTELLATION HOLDINGS LIMITED"', () => {
    ...
    it('nzbn_at_date should find nzbn for company name at date', () => {
    ...
    it('company_name_at_date should find company name at 06 July 1992 for given company name at 06 July 1997', () => {
